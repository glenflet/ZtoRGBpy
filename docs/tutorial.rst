...
Tutorials
=========
The following tutorials provide examples of the general usage of the ZtoRGBpy package:

.. toctree::

    tutorial/basic_usage.rst
    tutorial/colorbars.rst
    tutorial/custom_scale.rst